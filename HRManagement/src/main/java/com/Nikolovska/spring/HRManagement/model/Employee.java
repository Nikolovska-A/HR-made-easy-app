...
public class Employee {
    ...
    @JoinTable(name = "EMPLOYEE_ITEMS", joinColumns = @JoinColumn(name = "id_employee", referencedColumnName = "id"), 
    	    inverseJoinColumns = @JoinColumn(name = "id_zadolzenija", referencedColumnName = "id"))
